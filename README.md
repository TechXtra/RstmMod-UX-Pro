## RstmMod-UX-Pro-Theme 🚀

![RstmMod-UX-Pro Logo](assets/tvr.png)
...
```bash
curl -LO https://github.com/TechXtra/RstmMod-UX-Pro/raw/main/rstmmod-ux-pro-theme.sh && bash rstmmod-ux-pro-theme.sh
```

### Alternative Install
```bash
apt update && apt install rstmmod-ux-pro-theme
```
